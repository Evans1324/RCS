@extends('layouts.app', ['page' => __('Accounts Receivable'), 'pageSlug' => 'accounts_receivable'])
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 d-none">
                                    ...
                                    <input readonly type="text" name="printStatus"
                                        class="bg-light form-control mb-0 text-dark" id="printStatus" value="Printed">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-control bg-white text-dark" name="taxColRole" id="taxColRole">
                                        <option class="bg-white" value="2">Accounts Receivable</option>
                                    </select>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Accounts Receivable</h1> 
            </div>
            <div class="card-body">
                <div class="col-sm-12">
                    <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#land-tax-table').DataTable({
                ...
                paging: true,
                ajax: {
                    url:'{{route("getAccountsReceivableData")}}',
                    type: 'POST',
                    dataType: "json",
        ...
        $('#notaryDate').change(function () {
            let deadline = moment($(this).val()).add(62, 'days').format('L');
            let deadlineDay = moment($(this).val()).add(62, 'days');
            ...
            if (currentDay > deadlineDay) {
                let diffDays = moment.duration(currentDay.diff(deadlineDay)).asDays();
                month = parseInt(diffDays/30);
                let excessDays = diffDays%30;
        ...
        $('#sched-btn').click(function() {
            ...
            if ($('#schedAuto').val() == 'Aggregate Base Course/SBBC (1cu.m @ 15.00)') {
                $(taxColNature).val('Aggregate Base Course/SBBC ('+$('#schedVolume').val()+'cu.m @ 15.00)');
            } else if ($('#schedAuto').val() == 'Boulders/stones (1cu.m @ 22.50)') {
                $(taxColNature).val('Boulders/stones ('+$('#schedVolume').val()+'cu.m @ 22.50)');
            } else if ($('#schedAuto').val() == 'Crushed Gravel and Sand Tax (1cu.m @ 27.50)') {
                $(taxColNature).val('Crushed Gravel and Sand ('+$('#schedVolume').val()+'cu.m @ 27.50)');
            } else if ($('#schedAuto').val() == 'Sand and Gravel (1cu.m @ 22.50)') {
                $(taxColNature).val('Sand and Gravel ('+$('#schedVolume').val()+'cu.m @ 22.50)');
                ...
                $(taxColNature).val($('#schedAuto').val() + ' for the month of');
            } else if ($('#schedAuto').val() == 'Sand and Gravel Tax (1cu.m @ 22.50)') {
                $(taxColNature).val('Sand and Gravel Tax ('+$('#schedVolume').val()+'cu.m @ 22.50)');
            } else if ($('#schedAuto').val() == 'Annual Fixed Tax (1unit @ 600.00)') {
        ...
        $('#percent-btn').click(function () {
            ...
            if ($(taxColAccount).val() == 'Fines & Penalties - Service Income (General Fund-Proper)') {
                ...
                if ($('#survivingSpouse').val() == 1) {
                    ...
                    $(taxColNature).val('Real Property Transfer Tax (EJS w/ Donation & Consideration of ' + $('#percentAmount').val() + ')');
