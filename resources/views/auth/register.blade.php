            ...
            <div class="card card-register card-white">
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group{{ $errors->has('office') ? ' has-danger' : '' }}">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <i class="tim-icons icon-components"></i>
                                </div>
                            </div>
                            <select name="office" class="form-control{{ $errors->has('office') ? ' is-invalid' : '' }}" placeholder="{{ __('Office') }}">
                                <option class="bg-swhite" value=""></option>
                                <option class="bg-swhite" value="Revenue">Revenue</option>
                                <option class="bg-swhite" value="Cash">Cash</option>
                            </select>
